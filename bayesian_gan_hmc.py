...
#from bgan_util import print_images, MnistDataset, CelebDataset, Cifar10, SVHN, ImageNet, OURS
from bgan_util import print_images, OURS
...
#        np.random.seed(args.random_seed)
    ...
    ours_path = os.path.join(args.data_path, "ours")    
